...
class MediaOrganizerpresentation(Scene):
    def construct(self):
        ...
        title = Text("Media Organizer",font="Boldonse", font_size=72, color=WHITE).shift(RIGHT*1.5).scale(0.7)
        ...
        reca=SurroundingRectangle(button, color=ORANGE, buff=0.1,corner_radius=0.1).set_fill(ORANGE, opacity=0.5)
