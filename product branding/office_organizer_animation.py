...
class OfficeOrganizerpresentation(Scene):
    def construct(self):
        ...
        title = Text("Office Organizer",font="Boldonse", font_size=72, color=WHITE).shift(RIGHT*1.5).scale(0.7)
        ...
        reca=SurroundingRectangle(button, color=BLUE, buff=0.1,corner_radius=0.1).set_fill(BLUE, opacity=0.5)
        ...
        lastdot = Dot(radius=20, color=BLUE).move_to(mouse.get_center())
