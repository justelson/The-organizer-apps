@echo off
echo Building Personal File Organizer...

echo Step 1: Creating executable with PyInstaller...
pyinstaller --clean --noconfirm personal_organizer.spec
...
echo Build complete! The installer is: PersonalFileOrganizerSetup.exe
pause