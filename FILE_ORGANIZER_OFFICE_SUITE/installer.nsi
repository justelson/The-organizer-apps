; Office File Organizer Installer Script
; Created with Nullsoft Scriptable Install System

; Define application information
!define APPNAME "Office File Organizer"
!define COMPANYNAME "JUST ELSON PRODUCTIVE.labs"
!define DESCRIPTION "A powerful tool for organizing your office files"
...
OutFile "OfficeFileOrganizerSetup.exe"
...
!define MUI_ICON "icon_office.ico"
!define MUI_UNICON "icon_office.ico"
...
Section "Install"
    ...
    ; Add files
    File "dist\OfficeFileOrganizer.exe"
    ...
    CreateShortcut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\OfficeFileOrganizer.exe"
    CreateShortcut "$DESKTOP\${APPNAME}.lnk" "$INSTDIR\OfficeFileOrganizer.exe"
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${COMPANYNAME}_${APPNAME}" "DisplayIcon" "$\"$INSTDIR\OfficeFileOrganizer.exe$\""
...
Section "Uninstall"
    ...
    Delete "$INSTDIR\OfficeFileOrganizer.exe"
